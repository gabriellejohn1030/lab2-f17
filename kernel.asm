...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 73 78 10 80 	movl   $0x80107873,(%esp)
...
80100b40:	e8 2b 20 00 00       	call   80102b70 <end_op>
  if((sp = allocuvm(pgdir, stackSize-1, KERNBASE-1)) == 0) //dont want to exceed the user memory
...
80100b81:	0f 84 95 01 00 00    	je     80100d1c <exec+0x37c>
...
80100d17:	e9 f6 fc ff ff       	jmp    80100a12 <exec+0x72>
  for(argc = 0; argv[argc]; argc++) {
80100d1c:	31 d2                	xor    %edx,%edx
80100d1e:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d24:	e9 14 ff ff ff       	jmp    80100c3d <exec+0x29d>
...
8010388c:	8b 43 7c             	mov    0x7c(%ebx),%eax
  *np->tf = *curproc->tf;
8010388f:	8b 79 18             	mov    0x18(%ecx),%edi
  np->parent = curproc;
80103892:	89 59 14             	mov    %ebx,0x14(%ecx)
  np->stackSZ = curproc->stackSZ;
80103895:	89 41 7c             	mov    %eax,0x7c(%ecx)
  *np->tf = *curproc->tf;
80103898:	8b 73 18             	mov    0x18(%ebx),%esi
...
801038a4:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
801038a6:	8b 40 18             	mov    0x18(%eax),%eax
801038a9:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
    if(curproc->ofile[i])
801038b0:	8b 44 b3 28          	mov    0x28(%ebx,%esi,4),%eax
...
80103e74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e78:	c7 04 24 73 78 10 80 	movl   $0x80107873,(%esp)
...
801044c3:	8b 45 08             	mov    0x8(%ebp),%eax
 // struct proc *curproc = myproc(); not necessary anymore
...
8010462d:	8b 14 85 20 75 10 80 	mov    -0x7fef8ae0(,%eax,4),%edx
...
80104656:	c7 04 24 f1 74 10 80 	movl   $0x801074f1,(%esp)
...
801047e0:	c7 44 24 04 9c 75 10 	movl   $0x8010759c,0x4(%esp)
801047e7:	80 
...
801047fb:	c7 44 24 04 9b 75 10 	movl   $0x8010759b,0x4(%esp)
80104802:	80 
...
80104811:	79 89                	jns    8010479c <create+0xdc>
      panic("create dots");
80104813:	c7 04 24 8f 75 10 80 	movl   $0x8010758f,(%esp)
8010481a:	e8 41 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010481f:	c7 04 24 9e 75 10 80 	movl   $0x8010759e,(%esp)
80104826:	e8 35 bb ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010482b:	c7 04 24 80 75 10 80 	movl   $0x80107580,(%esp)
...
80104bd1:	c7 44 24 04 9c 75 10 	movl   $0x8010759c,0x4(%esp)
80104bd8:	80 
...
80104be9:	c7 44 24 04 9b 75 10 	movl   $0x8010759b,0x4(%esp)
80104bf0:	80 
...
80104d3d:	c7 04 24 c0 75 10 80 	movl   $0x801075c0,(%esp)
80104d44:	e8 17 b6 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d49:	c7 04 24 d2 75 10 80 	movl   $0x801075d2,(%esp)
80104d50:	e8 0b b6 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d55:	c7 04 24 ae 75 10 80 	movl   $0x801075ae,(%esp)
...
80105209:	e8 02 1c 00 00       	call   80106e10 <shm_open>
}
8010520e:	c9                   	leave  
8010520f:	c3                   	ret    
    return -1;
...
80105243:	e8 d8 1b 00 00       	call   80106e20 <shm_close>
}
80105248:	c9                   	leave  
80105249:	c3                   	ret    
...
80105489:	c7 44 24 04 e1 75 10 	movl   $0x801075e1,0x4(%esp)
80105490:	80 
...
80105512:	0f 84 18 02 00 00    	je     80105730 <trap+0x230>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105520:	ff 24 85 f4 76 10 80 	jmp    *-0x7fef890c(,%eax,4)
80105527:	90                   	nop
      exit();
    }
    break;
...
80105593:	c7 04 24 b0 76 10 80 	movl   $0x801076b0,(%esp)
...
80105643:	39 43 44             	cmp    %eax,0x44(%ebx)
80105646:	0f 82 1c 01 00 00    	jb     80105768 <trap+0x268>
8010564c:	0f 20 d0             	mov    %cr2,%eax
8010564f:	85 c0                	test   %eax,%eax
80105651:	0f 88 11 01 00 00    	js     80105768 <trap+0x268>
      uint curTop = KERNBASE - myproc()->stackSZ * PGSIZE;
80105657:	e8 34 e0 ff ff       	call   80103690 <myproc>
8010565c:	8b 40 7c             	mov    0x7c(%eax),%eax
8010565f:	f7 d8                	neg    %eax
80105661:	c1 e0 0c             	shl    $0xc,%eax
      if (allocuvm(myproc()->pgdir, PGROUNDDOWN(curTop - 1), curTop - 1)
80105664:	8d b0 ff ff ff 7f    	lea    0x7fffffff(%eax),%esi
8010566a:	e8 21 e0 ff ff       	call   80103690 <myproc>
8010566f:	89 74 24 08          	mov    %esi,0x8(%esp)
80105673:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105679:	89 74 24 04          	mov    %esi,0x4(%esp)
8010567d:	8b 40 04             	mov    0x4(%eax),%eax
80105680:	89 04 24             	mov    %eax,(%esp)
80105683:	e8 28 12 00 00       	call   801068b0 <allocuvm>
80105688:	85 c0                	test   %eax,%eax
8010568a:	0f 84 28 01 00 00    	je     801057b8 <trap+0x2b8>
      myproc()->stackSZ++;
80105690:	e8 fb df ff ff       	call   80103690 <myproc>
80105695:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
      cprintf("Increased stack size\n");
80105699:	c7 04 24 e6 75 10 80 	movl   $0x801075e6,(%esp)
801056a0:	e8 ab af ff ff       	call   80100650 <cprintf>
      if (tf->esp >= rcr2() && rcr2() < KERNBASE) {
801056a5:	e9 06 ff ff ff       	jmp    801055b0 <trap+0xb0>
801056aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801056b0:	e8 bb df ff ff       	call   80103670 <cpuid>
801056b5:	85 c0                	test   %eax,%eax
801056b7:	0f 84 cb 00 00 00    	je     80105788 <trap+0x288>
...
801056fc:	c7 04 24 04 76 10 80 	movl   $0x80107604,(%esp)
...
80105714:	eb a7                	jmp    801056bd <trap+0x1bd>
80105716:	66 90                	xchg   %ax,%ax
    ideintr();
80105718:	e8 53 c9 ff ff       	call   80102070 <ideintr>
8010571d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105720:	e8 4b d0 ff ff       	call   80102770 <lapiceoi>
    break;
80105725:	e9 86 fe ff ff       	jmp    801055b0 <trap+0xb0>
...
8010573a:	75 44                	jne    80105780 <trap+0x280>
    myproc()->tf = tf;
...
80105768:	c7 04 24 50 76 10 80 	movl   $0x80107650,(%esp)
8010576f:	e8 dc ae ff ff       	call   80100650 <cprintf>
      exit();
80105774:	e8 17 e3 ff ff       	call   80103a90 <exit>
80105779:	e9 32 fe ff ff       	jmp    801055b0 <trap+0xb0>
8010577e:	66 90                	xchg   %ax,%ax
      exit();
80105780:	e8 0b e3 ff ff       	call   80103a90 <exit>
80105785:	eb b5                	jmp    8010573c <trap+0x23c>
80105787:	90                   	nop
      acquire(&tickslock);
80105788:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010578f:	e8 9c e9 ff ff       	call   80104130 <acquire>
      wakeup(&ticks);
80105794:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
8010579b:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
801057a2:	e8 d9 e5 ff ff       	call   80103d80 <wakeup>
      release(&tickslock);
801057a7:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801057ae:	e8 6d ea ff ff       	call   80104220 <release>
801057b3:	e9 05 ff ff ff       	jmp    801056bd <trap+0x1bd>
        cprintf("PGFLT: Page could not be allocated.\n");
801057b8:	c7 04 24 28 76 10 80 	movl   $0x80107628,(%esp)
801057bf:	e8 8c ae ff ff       	call   80100650 <cprintf>
        exit();
801057c4:	e8 c7 e2 ff ff       	call   80103a90 <exit>
801057c9:	e9 c2 fe ff ff       	jmp    80105690 <trap+0x190>
...
801057e8:	c7 04 24 7c 76 10 80 	movl   $0x8010767c,(%esp)
801057ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801057f3:	e8 58 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057f8:	c7 04 24 fc 75 10 80 	movl   $0x801075fc,(%esp)
...
801058f7:	00 
  for(p="xv6...\n"; *p; p++)
801058f8:	bb bc 77 10 80       	mov    $0x801077bc,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106621:	c3                   	ret    
      panic("remap");
80106622:	c7 04 24 c4 77 10 80 	movl   $0x801077c4,(%esp)
...
80106731:	c7 04 24 ca 77 10 80 	movl   $0x801077ca,(%esp)
80106738:	e8 23 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010673d:	c7 04 24 f5 77 10 80 	movl   $0x801077f5,(%esp)
80106744:	e8 17 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106749:	c7 04 24 e0 77 10 80 	movl   $0x801077e0,(%esp)
...
801067de:	c7 04 24 09 78 10 80 	movl   $0x80107809,(%esp)
...
80106892:	c7 04 24 23 78 10 80 	movl   $0x80107823,(%esp)
80106899:	e8 c2 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010689e:	c7 04 24 c4 78 10 80 	movl   $0x801078c4,(%esp)
...
80106942:	c7 04 24 41 78 10 80 	movl   $0x80107841,(%esp)
...
80106970:	c7 04 24 59 78 10 80 	movl   $0x80107859,(%esp)
...
80106a33:	e9 a8 b8 ff ff       	jmp    801022e0 <kfree>
    panic("freevm: no pgdir");
80106a38:	c7 04 24 75 78 10 80 	movl   $0x80107875,(%esp)
...
80106b1b:	c3                   	ret    
    panic("clearpteu");
80106b1c:	c7 04 24 86 78 10 80 	movl   $0x80107886,(%esp)
...
80106b43:	0f 84 6f 01 00 00    	je     80106cb8 <copyuvm+0x188>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106bb7:	0f 84 0e 01 00 00    	je     80106ccb <copyuvm+0x19b>
    if(!(*pte & PTE_P))
80106bbd:	8b 30                	mov    (%eax),%esi
80106bbf:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106bc5:	0f 84 f4 00 00 00    	je     80106cbf <copyuvm+0x18f>
    pa = PTE_ADDR(*pte);
...
80106c00:	e8 8b ca ff ff       	call   80103690 <myproc>
80106c05:	bb fe 0f 00 80       	mov    $0x80000ffe,%ebx
80106c0a:	8b 40 7c             	mov    0x7c(%eax),%eax
80106c0d:	c1 e0 0c             	shl    $0xc,%eax
80106c10:	29 c3                	sub    %eax,%ebx
80106c12:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106c18:	79 54                	jns    80106c6e <copyuvm+0x13e>
80106c1a:	e9 8e 00 00 00       	jmp    80106cad <copyuvm+0x17d>
80106c1f:	90                   	nop
	memmove(mem, (char*)P2V(pa), PGSIZE);
...
80106c35:	e8 d6 d6 ff ff       	call   80104310 <memmove>
	if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
...
80106c5d:	e8 4e f9 ff ff       	call   801065b0 <mappages>
80106c62:	85 c0                	test   %eax,%eax
80106c64:	78 85                	js     80106beb <copyuvm+0xbb>
 for(i = PGROUNDUP(KERNBASE - 1 - myproc()->stackSZ * PGSIZE); i < KERNBASE; i += PGSIZE){
80106c66:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c6c:	78 3f                	js     80106cad <copyuvm+0x17d>
	if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c6e:	8b 45 08             	mov    0x8(%ebp),%eax
80106c71:	31 c9                	xor    %ecx,%ecx
80106c73:	89 da                	mov    %ebx,%edx
80106c75:	e8 46 f7 ff ff       	call   801063c0 <walkpgdir>
80106c7a:	85 c0                	test   %eax,%eax
80106c7c:	74 4d                	je     80106ccb <copyuvm+0x19b>
	if(!(*pte & PTE_P))
80106c7e:	8b 30                	mov    (%eax),%esi
80106c80:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c86:	74 37                	je     80106cbf <copyuvm+0x18f>
    	pa = PTE_ADDR(*pte);
80106c88:	89 f7                	mov    %esi,%edi
    	flags = PTE_FLAGS(*pte);
80106c8a:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c90:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    	pa = PTE_ADDR(*pte);
80106c93:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
	if((mem = kalloc()) == 0)
80106c99:	e8 f2 b7 ff ff       	call   80102490 <kalloc>
80106c9e:	85 c0                	test   %eax,%eax
80106ca0:	89 c6                	mov    %eax,%esi
80106ca2:	0f 85 78 ff ff ff    	jne    80106c20 <copyuvm+0xf0>
80106ca8:	e9 3e ff ff ff       	jmp    80106beb <copyuvm+0xbb>
...
80106cba:	e9 39 ff ff ff       	jmp    80106bf8 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106cbf:	c7 04 24 aa 78 10 80 	movl   $0x801078aa,(%esp)
80106cc6:	e8 95 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106ccb:	c7 04 24 90 78 10 80 	movl   $0x80107890,(%esp)
...
80106db6:	c7 44 24 04 e8 78 10 	movl   $0x801078e8,0x4(%esp)
80106dbd:	80 
